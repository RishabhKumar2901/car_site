export const amcData = {
  vehicleTypes: [
    { label: "Hatchback", price: 3999 },
    { label: "Sedan", price: 5999 },
    { label: "SUV", price: 7999 },
