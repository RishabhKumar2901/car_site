export const faqonNearByCarServiceData = [
    {
      question: "What is VehicleCare",
      answer:
    ...
    {
      question: "Why choose VehicleCare?",
      answer:
    ...
    {
      question: "How can I book a car service with VehicleCare?",
      answer:
    ...
    {
      question: "What services are available at VehicleCare Workshops?",
      answer:
    ...
    {
      question: "In how many cities is VehicleCare available?",
      answer:
    ...
    {
      question:
        "Does VehicleCare provide car pickup, drop, and doorstep service?",
      answer:
    ...
    {
      question: "How can I track the status of my car service?",
      answer:
        "teDownload the VehicleCare App from the Play Store, log in with your registered mobile number, and navigate to the order section. Real-time updates related to your service will be readily available.xt",
    },
    {
      question: "Do VehicleCare workshops support online payments?",
      answer:
