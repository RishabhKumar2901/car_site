...
const FAQonServices = ({ questions }: { questions: any[] }) => {
  ...
  return (
    <div className="pt-10 pb-20 w-full flex flex-col items-center justify-center">
      <div className="w-[95%] lg:w-[70%]">
        <div className="text-2xl lg:text-[1.75rem] font-semibold mt-4 font-montserrat mb-10">
        Frequently Asked Questions on VehicleCare Periodic Car Services:
        </div>
